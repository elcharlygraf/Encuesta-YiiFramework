...
$config = array();
$config['siteadminemail']     = 'carlox16@gmail.com'; // The default email address of the site administrator
$config['siteadminbounce']    = 'carlox16@gmail.com'; // The default email address used for error notification of sent messages for the site administrator (Return-Path)
$config['siteadminname']      = 'Juan Carlos';      // The name of the site administrator
...
$config['emailsmtpuser']      = 'carlox16@gmail.com';               // SMTP authorisation username - only set this if your server requires authorization - if you set it you HAVE to set a password too
$config['emailsmtppassword']  = 'iperu2012';               // SMTP authorisation password - empty password is not allowed
